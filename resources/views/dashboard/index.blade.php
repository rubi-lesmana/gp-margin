                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    @forelse ($topSales as $sales)
                                        <tr>
                                            <td data-label="Name">{{ $sales['name'] }}</td>
                                            <td class="text-center" data-label="Request">{{ $sales['total_request'] }}</td>
                                            <td class="text-center" data-label="Approved">{{ $sales['approved'] }}</td>
                                            <td class="text-center" data-label="Approval Rate">
                                                @php
                                                    $badgeMap = [
