    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col">
                        <h4 class="card-title">List Data Pareto</h4>
                    </div>
                    <div class="col d-flex justify-content-end gap-2 p-2">
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                            data-bs-target="#add_pareto">
                ...
                <div class="row">
                    ...
                    <div class="col-12 table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a type="button"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#delete_pareto{{ $pareto->id }}"
                                                title="Delete">
                                                <i
                        ...
                        {{-- Modal View Add Data --}}
                        @include('setup.pareto.create')
                        @include('setup.pareto.update')
                        @include('setup.pareto.delete')
