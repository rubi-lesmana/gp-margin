    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col">
                        <h4 class="card-title">List Data Currency</h4>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a type="button"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#edit_currency{{ $currency->id_currency }}"
                                                title="Edit">
                                                <i
                                            ...
                                            <a type="button"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#delete_currency{{ $currency->id_currency }}"
                                                title="Delete">
                                                <i
                        ...
                        {{-- Modal View Add Data --}}
                        @include('setup.currency.create')
                        @include('setup.currency.update')
                        @include('setup.currency.delete')
