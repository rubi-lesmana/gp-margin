    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col">
                        <h4 class="card-title">List Data Item History</h4>
                    </div>
                    <div class="col d-flex justify-content-end gap-2 p-2">
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                            data-bs-target="#add_item_history">
                ...
                <div class="row">
                    ...
                    <div class="col-12 table-responsive">
                            ...
                            <tbody>
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td class="text-wrap">{{ $row->item->description }}</td>
                                        <td>{{ $row->date_report }}</td>
                                        <td>{{ $row->ending_stock }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a type="button"
                                                ...
                                                data-bs-target="#edit_item_history{{ $row->id }}" title="Edit">
                                                <i
                                            ...
                                            <a type="button"
                                                ...
                                                data-bs-toggle="modal"
                                                data-bs-target="#delete_item_history{{ $row->id }}" title="Delete">
                                                <i
                        ...
                        {{-- Modal View Add Data --}}
                        @include('master.item-history.create')
                        @include('master.item-history.update')
                        @include('master.item-history.delete')
